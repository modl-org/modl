...
pub(crate) const TRAINER_TORCHAUDIO_VERSION: &str = "2.7.0";
...
// f1bc650: first pin with the krea2 arch (Krea 2 Raw + edit-LoRA training).
pub(crate) const AITOOLKIT_PIN_SHA: &str = "f1bc6508ad63369ea2ac684a8ba929a9ab685c1e";
